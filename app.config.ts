  ...
  plugins: [
    ...
    [
      "expo-splash-screen",
      {
        ...
        // (sand), which matched nothing else in the app. It shows for the
        // instant before the image resolves, so it must equal the image's own
        // background or the launch flickers between two colours.
        backgroundColor: "#214D2D",

        // Generated by make-splash.js at 1290x2796 from the app's own tokens
        // and the real Georgia. Regenerate rather than hand-editing, so the
        // wordmark keeps matching the one used everywhere else in the app.
        ios: {
        ...
        dark: {
          ios:     { image: "./assets/images/flipstart-splash.png", backgroundColor: "#214D2D" },
          android: { image: "./assets/images/flipstart-splash.png", backgroundColor: "#214D2D" },
        },
      },
    ],
    [
