...
import type {
  ...
  export function validateAnalysis(input: ValidationInput): ValidationOutput {
    ...
    const descriptive: Array<[string[], string]> = [
      ...
      [ai.photo_evidence.front_evidence, "front_evidence"],
      [ai.photo_evidence.tag_evidence, "tag_evidence"],
      [ai.photo_evidence.detail_evidence, "detail_evidence"],
      ...
      [ai.risks.risky_buy_reasons, "risky_buy_reasons"],
